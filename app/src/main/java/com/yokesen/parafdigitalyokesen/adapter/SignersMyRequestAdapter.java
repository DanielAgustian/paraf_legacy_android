...
public class SignersMyRequestAdapter extends RecyclerView.Adapter<SignersMyRequestAdapter.ViewHolder> {
    Context context;
    View contactView;
    @NonNull
    @Override
    public SignersMyRequestAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
...
//            }
     ...
     * */
    public SignersMyRequestAdapter(List<SignersModel> mSigners,  FragmentManager fragmentManager, int id) {
